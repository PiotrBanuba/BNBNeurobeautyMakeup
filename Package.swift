...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-62-g077d3df291/BNBNeurobeautyMakeup.zip",
            checksum: "ea5a1e415f4dd14559b8f2adbdcf1c4a1828158c9cff127ac20d4935ff8d062f"
        ),
        .target(
