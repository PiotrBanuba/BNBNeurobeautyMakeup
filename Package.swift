...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-61-g2b7f7b2a6c/BNBNeurobeautyMakeup.zip",
            checksum: "c5a9546a65de7906ff55771df0004dca0c61d771f7e60b3c4a572e2b7ccaa187"
        ),
        .target(
