...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g6aa1953f1a/BNBNeurobeautyMakeup.zip",
            checksum: "72ed529f1358c9c1f1ed692af63ff3534912c39455546af1273d1f7b7d8b543e"
        ),
        .target(
