...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-83-gf89cbbd807/BNBNeurobeautyMakeup.zip",
            checksum: "300690b99c51eade2a7076b5b4881aa2170853619657cd118bb817989d169e25"
        ),
        .target(
