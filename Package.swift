...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-64-g951557ebd1/BNBNeurobeautyMakeup.zip",
            checksum: "e07cd8052b78f0393485e2b2141da5d1337212b55bad2e32903b38ab1cf9b216"
        ),
        .target(
